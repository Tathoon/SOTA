...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($produit_id) {
            ...
            header('Location: produits.php?message=' . urlencode('Produit créé avec succès'));
            exit();
        } else {
...
<head>
    ...
    <title>Nouveau produit - SOTA Fashion</title>
    ...
    <div class="container dashboard-container">
        ...
        <main class="main-content dashboard-main">
            ...
            <section class="dashboard-header">
                <h1><i class="fas fa-plus"></i> Nouveau produit</h1>

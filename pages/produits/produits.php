...
<head>
    ...
    <title>Gestion des produits - SOTA Fashion</title>
                ...
                <?php if (empty($produits)): ?>
                    <div style="text-align: center; padding: 50px; background: white; margin: 0 30px; border-radius: 12px;">
                        ...
                        <p style="color: #999; margin-bottom: 20px;">
                            <?= $search || $category || $statut_stock ? 'Aucun produit ne correspond à vos critères de recherche.' : 'Votre catalogue est vide.' ?>
                        </p>
